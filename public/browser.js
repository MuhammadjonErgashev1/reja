...
document.addEventListener("click", function(e){
    ...
    if(e.target.classList.contains("delete-me")){
       if(confirm("aniq ochirmoqchimisz")){
        ...
        .catch((err)=>{
            console.log("iltimos qaytadan ishlatish")
        })
       }
    ...
    if(e.target.classList.contains("edit-me")){
        let userInput = prompt("ozgartirish kiriting", e.target.parentElement.parentElement
            ...
            if(userInput){
                ...
                .catch((err)=>{
                        console.log("iltomos qaytadan urunib ko'ring")
                })
            }
